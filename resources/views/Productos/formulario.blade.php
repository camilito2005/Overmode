            ...
            <form action="{{ route('productos.guardar') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" name="precio" id="precio" step="0.01" value="{{ old('precio') }}" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#modalAgregarCategoria">+</button>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div id="variantes-container">
                        <div class="row g-2 align-items-end variante-item mb-2">
                            ...
                            <div class="col-md-1">
                                <button type="button" class="btn btn-sm btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#modalAgregarTalla">+</button>
                            </div>
                            ...
                            <div class="col-md-1">
                                <button type="button" class="btn btn-sm btn-outline-primary w-100" data-bs-toggle="modal" data-bs-target="#modalAgregarColor">+</button>
                            </div>

                            <div class="col-md-4">
                                <input type="number" name="variantes[0][stock]" min="0" class="form-control" placeholder="Stock">
                            </div>
                        </div>
                    </div>
